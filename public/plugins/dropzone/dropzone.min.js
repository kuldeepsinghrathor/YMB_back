    ...
    return function() {
                    ...
                    var r, i = n(2109),
                        ...
                        Ae = function(e, t, n, i) {
                            var o, a, u, s, l, c = n || re,
                                ...
                                y = !1,
                                g = !1;
                            for (n || (e.scheme = "", e.user, e.password = "", e.host = null, e.port = null, e.path = [], e.query = null, e.fragment = null, e.cannotBeABaseURL = !1, t = t.replace(j, "")), t = t.replace(D, ""), o = h(t); p <= o.length;) {
                                switch (a = o[p], c) {
                                    case re:
                                        if (!a || !L.test(a)) {
                                            if (n) return F;
        ...
        return function() {
            ...
            var s = {
                ...
                fallback: function() {
                    var e;
                    this.element.class.concat(this.element.className, " dz-browser-not-supported");
