...
! function() {
            ...
            return ((e, t, n) => e.exists((e => ((e, t) => !kh(e) && Eh(e, t).exists((e => {
                ...
                if (r.length > 0) {
                    if (o) return I.some(wh.partialTable(r, I.none())); {
                        const e = Ah(n, t);
                        return I.some(wh.partialTable(r, I.some({ ...t,
                            rng: e
                        })))
                    }
                }
    ...
    const Lv = (e, t, n) => Tv(e).bind((({
        ...
        Fv = (e, t) => {
            const n = e.schema;
            t.remove_trailing_brs && Ov(t, e, n), e.addAttributeFilter("href", (e => {
                let n = e.length;
                const o = e => {
                    const t = e ? Dt.trim(e) : "";
    ...
    const Ky = (e, t, n, o) => {
                                ...
                                if (1 === e.type) {
                                    ...
                                    if (r && i) {
                                        ...
                                        i.paddInEmptyBlock && r && (e => {
                                            ...
                                            return !1
                                        })(e) ? Qh(n, o, f, e) : i.removeEmpty && r ? f(e) ? e.remove() : e.unwrap() : i.paddEmpty && (r || (e => {
                                            var t;
        ...
        aC = (e, t) => {
            if (t.no_events) return al.value(t); {
                const n = oC(t.content, (n => ((e, t) => e.dispatch("BeforeSetContent", t))(e, { ...t,
                    content: n
                })), rc(e));
    ...
    const wk = (e, t, n, o, r, s) => {
        ...
        FE = (e, t) => J(((e, t) => te((e => V(e, (e => ({ ...LE,
            ...e
        }))))(e), (e => ME(e, t) ? [e] : [])))(e, t), (e => e.action())),
        UE = (e, t) => ue(((e, t) => te((e => V(e, (e => ({ ...LE,
            ...e
        }))))(e), (e => ME(e, t) ? [e] : [])))(e, t), (e => e.action())),
        zE = (e, t) => {
            const n = t ? Zc.Forwards : Zc.Backwards,
    ...
    const sA = (e, t) => Math.abs(e.left - t),
        ...
        bO = Oa.DOM,
        vO = e => "-" === e.charAt(0),
        yO = (e, t, n) => I.from(t).filter((e => Ge(e) && !iw.has(e))).map((t => ({
        ...
        PO = Yt("font"),
        LO = e => (t, n) => I.from(n).map(vn).filter(qt).bind((n => ((e, t, n) => bb(vn(n), (t => (t => co(t, e).orThunk((() => PO(t) ? xe(DO, e).bind((e => en(t, e))) : I.none())))(t)), (e => kn(vn(t), e))))(e, t, n.dom).or(((e, t) => I.from(Oa.DOM.getStyle(t, e, !0)))(e, n.dom)))).getOr(""),
        MO = LO("font-size"),
        IO = S((e => e.replace(/[\'\"\\]/g, "").replace(/,\s+/g, ",")), LO("font-family")),
        FO = e => Cu(e.getBody()).bind((e => {
            const t = e.container();
        ...
        })))(e).orThunk(O(FO, e)).map(vn).filter(qt).bind(t))(e, _(I.some, t)),
        zO = (e, t) => {
            if (/^[0-9.]+$/.test(t)) {
